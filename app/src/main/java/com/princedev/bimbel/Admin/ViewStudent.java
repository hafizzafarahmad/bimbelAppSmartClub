...
public class ViewStudent extends AppCompatActivity {
    ...
    Context mContext = ViewStudent.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parentEdt = findViewById(R.id.form_edt_parent);
        phoneParentEdt = findViewById(R.id.form_edt_parentphone);
        ...
        jadwalbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ViewStudent.this, ViewJadwalActivity.class);
